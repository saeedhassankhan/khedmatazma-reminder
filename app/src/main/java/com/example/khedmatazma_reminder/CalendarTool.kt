...
class CalendarTool {
    ...
    val iranianDate: String
        get() = "$iranianYear/$irMonth/$iranianDay"
    ...
    private var irMonth: Int = 0 // Month part of a Iranian date
    /**
    ...
    var gregorianYear: Int = 0
        private set // Year part of a Gregorian date
    /**
    ...
    var gregorianMonth: Int = 0
        private set // Month part of a Gregorian date
    /**
    ...
    var gregorianDay: Int = 0
        private set // Day part of a Gregorian date
    /**
    ...
    var julianYear: Int = 0
        private set // Year part of a Julian date
    /**
    ...
    var julianMonth: Int = 0
        private set // Month part of a Julian date
    /**
     ...
     */
    var julianDay: Int = 0
        private set // Day part of a Julian date
    ...
    /**
     *
     * @param gregorianDate input date sample 2018-8-16
     * @return
     */
    fun gregorianToIrani(gregorianDate: String?): String {
        val calendarTool = CalendarTool()
        val sDate = gregorianDate?.split("-".toRegex())?.dropLastWhile { it.isEmpty() }?.toTypedArray()
        calendarTool.setGregorianDate(
            Integer.parseInt(sDate?.get(0)),
            Integer.parseInt(sDate?.get(1)),
            Integer.parseInt(sDate?.get(2))
        )
        val cFormat = CFormat()
        return cFormat.getServerDateFormat(calendarTool.iranianYear, calendarTool.iranianMonth, calendarTool.iranianDay)
    }
    ...
    private fun IranianDateToJDN(): Int {
        ...
        return gregorianDateToJDN(
            ...
            3,
            march
        ) + (irMonth - 1) * 31 - irMonth / 7 * (irMonth - 7) + iranianDay - 1
    }
